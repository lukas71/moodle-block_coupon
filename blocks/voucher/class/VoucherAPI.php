...
final class VoucherAPI
{
     ...
     * 
     * @example <pre>
     * $url = 'http://moodle26.menno.extern.ds.office.sebsoft.nl/blocks/voucher/view/api.php?method=GenerateVouchersForCourse&courses[0]=1&courses[1]=2&amount=5&email=menno@sebsoft.nl&groups[0]=1&groups[1]=2&generate_single_pdfs=1&resultType=xml';<br />
     * <br />
     * $params = array(<br />
     *     'username' => '{API username}',<br />
     *     'password' => '{API password}'<br />
